...
from .views import (
	...
	BusinessCardListCreateView, BusinessCardDetailView,
	EulogyListCreateView, EulogyDetailView,
	DashboardView
)
...
urlpatterns = [
	...
	path('orders/<int:order_id>/business-card/', BusinessCardListCreateView.as_view(), name='business-card-create'),
	path('business-cards/<int:pk>/', BusinessCardDetailView.as_view(), name='business-card-detail'),
	path('orders/<int:order_id>/eulogy/', EulogyListCreateView.as_view(), name='eulogy-create'),
	path('eulogies/<int:pk>/', EulogyDetailView.as_view(), name='eulogy-detail'),
